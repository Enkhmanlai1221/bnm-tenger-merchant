...
const renderShape = (
  ...
  const maxWidth = 46; // Maximum width in pixels
  ...
  // If width exceeds maxWidth, center the bar
  if (layout === "horizontal" && width > maxWidth) {
    const diff = width - maxWidth;
    x = x + diff / 2;
    width = maxWidth;
  }

  const borderRadius = Math.min(width, height, 12) / 2; // Maximum of 12px, minimum of half the smallest dimension
...
const data = [
  { date: "May 23", Sales: 320 },
  { date: "Jun 23", Sales: 450 },
  { date: "Jul 23", Sales: 380 },
  { date: "Aug 23", Sales: 590 },
  { date: "Sep 23", Sales: 720 },
  { date: "Oct 23", Sales: 850 },
  { date: "Nov 23", Sales: 1100 },
  { date: "Dec 23", Sales: 1300 },
  { date: "Jan 24", Sales: 980 },
  { date: "Feb 24", Sales: 1050 },
  { date: "Mar 24", Sales: 1200 },
  { date: "Apr 24", Sales: 1400 },
  { date: "May 24", Sales: 1600 },
  { date: "Jun 24", Sales: 1800 },
  { date: "Jul 24", Sales: 2000 },
  { date: "Aug 24", Sales: 2200 },
];
