...
const Button = React.forwardRef(
  (
    ...
    const backgroundColors = {
      ...
      default: "bg-light-button hover:bg-gray-50",
      light: "",
    };

    const border = {
      primary: "border-none",
      secondary: "border-2 border-lime-800 dark:border-white",
      default: "border border-gray-200",
      light: "",
    };
    let baseClasses = [
      "inline-flex items-center justify-center align-middle rounded-lg transition-all duration-800",
      textSize[size],
      padding[size],
      border[variant],
