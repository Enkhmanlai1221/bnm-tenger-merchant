"use client";
import { authMerchantApi } from "@/apis";
...
const MerchantProfileForm = ({ onSuccess }: { onSuccess?: () => void }) => {
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      ...
      await authMerchantApi.updateProfile(values);
      await authApi.me();
      message.success(
        translate(
...
MerchantProfileForm.displayName = "MerchantProfileForm";
